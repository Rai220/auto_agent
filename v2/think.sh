...
# Агент не выполняет шаги из TODO, а думает: пересматривает цели,
# ищет противоречия, генерирует новые идеи, задаёт себе вопросы.
#
# Использование:
...
# Собираем контекст — тот же, что и в run.sh
