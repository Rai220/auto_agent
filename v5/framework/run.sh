...
Протокол: прочитай контекст выше, определи следующий шаг из TODO.md и выполни его. Если незакрытых шагов больше не осталось, не создавай новый TODO-цикл в этом запуске: только зафиксируй завершение в MEMORY.md, JOURNAL.md, TODO.md и GOALS.md и закончи работу."
